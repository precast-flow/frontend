...
/** Eski neo/gri liste–detay düzeni (karşılaştırma için `?legacy=1`). */
export function UserManagementViewLegacy(props: UserManagementState) {
  const baseId = useId()
  const {
    factories,
    users,
            ...
            <>
              <div className="flex flex-wrap items-start justify-between gap-2 border-b border-gray-200/90 pb-3 dark:border-gray-700/90">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    type="button"
                    className={btnNeo}
                    onClick={() => mockPasswordReset('Şifre sıfırlama e-postası kuyruğa alındı (mock toast).')}
              ...
              <div className="mt-auto border-t border-gray-200/90 pt-3 dark:border-gray-700/90">
                <button
                  ...
                  disabled={!selected.active}
                  onClick={() => mockSave('Değişiklikler kaydedildi (mock).')}
                >
                  Kaydet (prototip)
                </button>
              </div>
          ...
          >
            ...
            <div className="mt-4 flex justify-end gap-2">
              ...
              <button
                ...
                className={btnDanger}
                onClick={() =>
                  confirmDeactivate('Kullanıcı pasifleştirildi (mock). Oturumlar sunucuda sonlandırılır.')
                }
              >
                Onayla
              </button>
