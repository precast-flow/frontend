...
const SETTINGS_SPLIT_PANE_KEY = 'settings-module'
const SETTINGS_LEGACY_SPLIT_STATE_KEY = 'settings-page:split-state'
...
export function SettingsModuleView(props: Props) {
  ...
  const {
    ...
    leftWidthStyle,
    setRatioFromPointer,
  } = useSplitPaneRatio(SETTINGS_SPLIT_PANE_KEY, 40, {
    legacyViewStateKey: SETTINGS_LEGACY_SPLIT_STATE_KEY,
  })
      ...
      >
        <section className={managementModuleListPanelClass(gl)} style={leftWidthStyle}>
          <div className={managementModuleListToolbarClass}>
            <h2 className={managementModuleListTitleClass}>{t('settingsModule.listTitle')}</h2>
