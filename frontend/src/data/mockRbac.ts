...
export const MOCK_ROLES: MockRole[] = [
  ...
  },
  {
    ...
    isSystem: false,
    userCount: 8,
    description: 'Saha montaj ve kurulum planları.',
  },
  {
    id: 'field',
    label: 'Saha',
...
export const ALL_PERMISSIONS: PermissionDef[] = [
  ...
  { id: 'genel.plan.birim.planlama', label: 'Genel plan — planlama görünümü', module: 'uretim' },
  { id: 'genel.plan.birim.uretim', label: 'Genel plan — üretim görünümü', module: 'uretim' },
  { id: 'genel.plan.birim.sevkiyat', label: 'Genel plan — sevkiyat görünümü', module: 'sevkiyat' },
  { id: 'genel.plan.birim.montaj', label: 'Genel plan — montaj görünümü', module: 'saha' },
  { id: 'genel.plan.planlama.duzenle', label: 'Genel plan — planlama düzenle', module: 'uretim' },
  { id: 'genel.plan.uretim.duzenle', label: 'Genel plan — üretim düzenle', module: 'uretim' },
  { id: 'genel.plan.sevkiyat.duzenle', label: 'Genel plan — sevkiyat düzenle', module: 'sevkiyat' },
  { id: 'genel.plan.montaj.duzenle', label: 'Genel plan — montaj düzenle', module: 'saha' },
  { id: 'genel.plan.filtre', label: 'Genel plan — filtreler', module: 'uretim' },
  { id: 'genel.plan.kuyruk', label: 'Genel plan — kuyruk', module: 'uretim' },
  { id: 'genel.plan.gecmis', label: 'Genel plan — geçmiş', module: 'uretim' },
  { id: 'genel.plan.kaydet', label: 'Genel plan — kaydet', module: 'uretim' },
  { id: 'genel.plan.yayinla', label: 'Genel plan — yayınla', module: 'uretim' },
...
export const MOCK_ROLE_PERMISSIONS: Record<string, Set<string>> = {
  ...
  planning: new Set([
    'uretim.emri.olustur',
    'uretim.durum.degistir',
    'proje.pano.goruntule',
    'mes.ek.1',
    'genel.plan.birim.planlama',
    'genel.plan.birim.uretim',
    'genel.plan.birim.sevkiyat',
    'genel.plan.birim.montaj',
    'genel.plan.planlama.duzenle',
    'genel.plan.uretim.duzenle',
    'genel.plan.sevkiyat.duzenle',
    'genel.plan.montaj.duzenle',
    'genel.plan.filtre',
    'genel.plan.kuyruk',
    'genel.plan.gecmis',
    'genel.plan.kaydet',
...
export const MOCK_ROLE_USERS: Record<string, { name: string; email: string }[]> = {
  ...
  assembly: [{ name: 'Deniz Arslan', email: 'deniz@acme.com' }],
